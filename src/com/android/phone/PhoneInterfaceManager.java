...
public class PhoneInterfaceManager extends ITelephony.Stub {
    ...
    private static final int CMD_GET_ALL_PIN_STATIS =10;
    private static final int EVENT_GET_ALL_PIN_STATIS =11;
	...
	public boolean Ringing(){
		 ...
		 return (call.state.INCOMING == call.getState()||call.state.WAITING == call.getState());
	}
    ...
    public int[] getAllPinStatis() {
        int[] PinStatis = {3,10,3,10};
	try{
		AsyncResult result = (AsyncResult)sendRequest(CMD_GET_ALL_PIN_STATIS, null);
		
		 if(result.exception == null) {
	 		if (result.result != null) {
				PinStatis = (int[])(result.result);
	 		}
	 	}else {
                	CommandException ex = (CommandException) result.exception;
			Log.e("GSM","[PhoneInterfaceManager]linda ====== getAllPinStatis:commandexception");
        	}
	} catch (RuntimeException e) {
            Log.e("GSM", "[PhoneInterfaceManager]linda =====getAllPinStatis: Runtime Exception");
        }
	return PinStatis;
    }
	/* linda add for set gsm phone data roaming enable */
    public void setDataOnRoamingEnabled (boolean enable)
    {
	  mPhone.setDataRoamingEnabled(enable);
    }
    /**
	...
	public boolean getMMSApnEnabled() throws RemoteException {
		// TODO Auto-generated method stub
		return false;
	}

	public boolean enableDataConnection(boolean enable, String reason)
